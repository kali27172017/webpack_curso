//AQUI HAGO LA  CONFIGURACION PARA ELEGIR MIS DEPENDENCIAS COMUNES   
...
module.exports = {
    entry:{ 
        //En vendor le indico que librerias quiero empaquetar
       vendor:[
          'react',
          'react-dom'
       ], 
    ...
    plugins: [
        ...
        new webpack.optimize.CommonsChunkPlugin({
            name: 'vendor', //aqui le pongo el nombre de mi paquete generado
            minChunks: Infinity //aqui le indico q no importa el numero de paquetes,
                               //generame mi paquete de vendors
        })
      ]
}