...
var _cursos = __webpack_require__(19);
   ...
   _createClass(Cursos, [{
      ...
      value: function render() {
         return _react2.default.createElement(
            'ul',
            { className: 'lista' },
            this.props.data.cursos.map(function (cursosData) {
               return _react2.default.createElement(Curso, cursosData);
            })
         );
      }
   }]);
...
(0, _reactDom.render)(_react2.default.createElement(Cursos, { data: _cursos2.default }), document.getElementById('main'));
